...
public class Step4 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        using (StreamWriter sw = new StreamWriter(m_path + "/Step4_T6.txt", true))
        {
    ...
    void Update()
    {
        ...
        {
            //if (angle < 155 && angle2 < 160 && angle3 < 160 && angle4 < 145 && angle5 < 160 && angle6 < 160 && angle7 < 140 && angle8 < 155 && angle9 < 130)
            ...
            {
                //Debug.Log("Step four complete");

                // stop timer and write time to file
                using (StreamWriter sw = new StreamWriter(m_path + "/time4_T6.txt", true))
                {
    ...
    void ManglePrint()
    {
        //print callibration angles for step 4 to file
        using (StreamWriter sw = new StreamWriter(m_path + "/Step4Mangle_T6.txt", true))
        {
