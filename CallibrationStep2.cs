...
public class CallibrationStep2 : MonoBehaviour
{
    //BONES
    ...
    public float midangle, midangle2, midangle3, midangle4, midangle5, midangle6, midangle7, midangle8, midangle9;
    ...
    void Update()
    {
        ...
        if (angle > 145 && angle2 > 155 && angle3 > 150 && angle4 > 140 && angle5 > 155 && angle6 > 150 && angle7 > 130 && angle8 > 150 && angle9 > 130)
        {
    ...
    {
        //save mid angles in Wait2 script
